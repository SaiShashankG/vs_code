...
- **Topics Covered**: Arrays, Strings, Sliding Window Approach (Fixed length and Variable length), Two Pointers Approach, Recursion, Sorting, Linked Lists(Slow and Fast pointers approach), Stacks, Queues, Binary Trees
- **Platform Problems**: LeetCode, Codeforces, CodeChef, Custom implementations
...
1. **Sliding Window**
   ...
   - Count subarrays with condition → atMost(k) formula
...
3. **In-Place Array Modification**
   - Duplicate removal with overwriting
